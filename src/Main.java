...
//        int[] diceTest = new int[]{6, 5, 2, 1, 1};
//
...
//        System.out.println(c.gotYatzy(diceTest));
//        System.out.println(c.straight(diceTest));
//
...
//
//        System.out.println("One pair (12): " + c.onePair(diceRoll));
//        System.out.println("Two pair (22): " + c.twoPair(diceRoll));
//
//        System.out.println("3 of a kind (18): " + c.nOfAKind(diceRoll, 3));
//        System.out.println("4 of a kind (24): " + c.nOfAKind(diceRoll, 4));
//
//        System.out.println("Small straight (15): " + c.straight(diceRoll));
//        System.out.println("Large straight: (20)" + c.straight(diceRoll));
//
